    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        try {
            ...
            if (ae.getSource() == Sign) {
                ...
                if (name2.equals("")||username.equals("") || dob.equals("") || email.equals("") || e_pass.equals("") || c_pass.equals("") || Objects.equals(city, "")) {
                    JOptionPane.showMessageDialog(null, "Fill All Fields");
                } else {
                    Conn c1 = new Conn();
                    String q1 = "insert into admin_table values('" + name2 + "','" + username + "','" + dob + "','" + email + "','" + e_pass + "','" + c_pass + "','" + "12345" + "','" + city + "')";
